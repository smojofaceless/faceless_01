-- Migration: Redo Job — Also clear api_usage to reset per-job cost limits
-- Without this, redone jobs hit "per-job call limit (30/30)" immediately
-- because the old api_usage rows are still counted by check_budget().
