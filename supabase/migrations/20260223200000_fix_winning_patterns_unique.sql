-- Fix: NULL vibe_preset causes duplicate rows in winning_metadata_patterns
-- PostgreSQL UNIQUE constraints treat NULL != NULL, so ON CONFLICT doesn't
-- detect existing NULL-vibe rows. NULLS NOT DISTINCT fixes this.
-- NOTE: The ALTER TABLE already ran successfully. Only the backfill remains.
