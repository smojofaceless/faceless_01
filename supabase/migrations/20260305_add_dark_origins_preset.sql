...
AS $$
  SELECT CASE p_preset
    ...
    WHEN 'dark_origins' THEN '{
      ...
      "camera_angles": ["wide establishing shot of isolated historical building at dusk", "medium shot of figure in period clothing half-lit by single lamp", "close-up of hands holding aged evidence (photographs, documents, objects)", "low angle looking up at imposing figure silhouetted in doorway", "overhead shot of crime scene or workshop with unsettling details", "extreme close-up of face half in shadow with one eye visible"],
      "tension_escalation": true,
